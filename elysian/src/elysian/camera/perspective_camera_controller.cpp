...
namespace ely
{
	PerspectiveCameraController::PerspectiveCameraController(float aspect_ratio) :
		m_camera(aspect_ratio)
	{
	}

	PerspectiveCameraController::PerspectiveCameraController(float aspect_ratio, const glm::vec3& camera_pos) :
